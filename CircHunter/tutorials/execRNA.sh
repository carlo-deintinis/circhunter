...
args="R CMD BATCH --no-save --no-restore  '--args   ${group} $fastqfolder $scratchfolder  $adapter5  $adapter3  $seqtype $thread $minlength $genomefolder $strandness $truncating $annotation ' ./Rscripts/rnaseqCounts.R  $output/Routput.Rout"
